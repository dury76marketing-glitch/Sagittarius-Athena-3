...
export const ATHENA_EXCLAMATION = Object.freeze({
  ...
  defaultMaxEntryCents:55,
  defaultMaxSpreadCents:3,
  defaultMinGameMinutes:20,
  defaultMaxGameMinutes:0,
  defaultMinRemainingUpsideCents:40,
  defaultMinimumGrowthRatio:0.50,
...
export const ATHENA_SOUL = Object.freeze({
  ...
  policyRevision:'S3-R1-GREEN-MID-AND-HIGH',
