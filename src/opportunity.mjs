...
function enabledAttackBands(settings={},askCents=0,{recoveryContext=null,fieldContext=null}={}){
  ...
  return rows.filter(([concept,flag])=>{
    ...
    // feasible: Crystal Wall needs an eligible recovery source. R65 Lightning
    // Plasma and Athena Exclamation are intentionally absent here because
    // Gemini-direct routing, not Atomic Thunder/Athena ranking, owns them.
