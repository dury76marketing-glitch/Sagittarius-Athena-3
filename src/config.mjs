...
export const RELEASE = 'SAGITTARIUS-R65-GEMINI-LIGHTNING-PLASMA-ATHENA-EXCLAMATION-2026-08-31';
...
export const CANONICAL_NUMERIC_SETTINGS = Object.freeze([
  ...
  // ATHENA-X1 universal profit activation. The legacy Infinity Break setting key is
  // intentionally retained as the operator-facing minimum net-profit threshold.
...
export function sanitizeRuntimeSettings(value = {}, defaults = originalSettings()) {
  ...
  // R65 LP2 has exactly three strike slots. This is doctrine, not an operator
  // sizing parameter: the single field budget is always divided by three.
  out.lightningPlasmaMaxStrikes = 3;
