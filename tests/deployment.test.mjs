...
const R56_PROJECT_SOURCE_FILE_BUDGET=46; // R65 adds Lightning Plasma Gemini-loss continuation tests; generated dependency files remain excluded.
...
test('R61 dashboard exposes Scarlet continuation controls and cache-busts the new frontend without old retracement doctrine',async()=>{
  ...
  assert.ok(engine.includes("noBoltNoAttackExceptions:['SCARLET_NEEDLE_POST_PROFIT_CONTINUATION','SAGITTARIUS_JUSTICE_ARROW_POST_SHADOW_WIN','CRYSTAL_WALL_POST_STOP_CONTINUATION','LIGHTNING_PLASMA_POST_SHADOW_LOSS']"));
